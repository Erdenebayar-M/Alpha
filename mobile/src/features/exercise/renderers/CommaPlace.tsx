// Reachable only via an explicit task.interaction_form: 'comma_place'
...
// no punctuation-with-gap-positions options shape for any of the 43 codes yet,
// so no real backend payload can select this renderer until one is added.
