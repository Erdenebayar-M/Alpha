// PARKED — unreachable from ExerciseEngine today. Registry key 'comma_place'
// has no entry in taskTypeMap: shared/src/validators/task.ts's
// TASK_TYPE_OPTION_SHAPE has no punctuation-with-gap-positions options shape
// for any of the 43 task_type codes, so no real payload can select this
// renderer. Keep it — it's finished, kid-tested UI — but it needs a backend
// task_type + options shape before it can go live. See taskTypeMap.ts's header.
