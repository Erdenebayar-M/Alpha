  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-[1440px] flex-col items-center gap-10 px-5 pb-24 pt-14 md:px-10 lg:flex-row lg:items-start lg:gap-[59px] lg:pt-19 lg:pb-24 lg:pl-[100px] lg:pr-20">
        {/* Widths are the old 192 / clamp(280,28vw,406) x 302/352: Mascot's box
            lost the dead space that used to pad its right edge, so the same
            drawn character now needs a narrower column. */}
        <div className="order-first w-[165px] shrink-0 lg:order-last lg:w-[clamp(240px,24vw,348px)]">
