...
function AppStoreBadge() {
  return (
    <a
      ...
      className="flex h-11 w-36 items-center gap-2 rounded-lg border border-border-card bg-black px-3 text-white transition-transform hover:-translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue focus-visible:ring-offset-2"
    >
      ...
      <span className="flex flex-col leading-none">
        <span className="text-[9px] text-white/80">Татаж авах</span>
